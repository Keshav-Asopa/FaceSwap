...
drawOverlay = False
cap = cv2.VideoCapture('/home/keshav/Desktop/presentation/FaceSwap/out.avi')
writer = None
...
while True:
    ...
    if key == ord('r'):
        if writer is None:
            ...
            writer = cv2.VideoWriter("../out.avi", cv2.VideoWriter_fourcc('X', 'V', 'I', 'D'), 5, (cameraImg.shape[1], cameraImg.shape[0]))
